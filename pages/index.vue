<template>
  ...
  <div>
    <div class="px-4 py-3 text-white bg-indigo-700">
    <p class="text-sm font-medium text-center">
      Découvrez notre nouvelle application bancaire !

      <a class="underline" href=""> En savoir plus &rarr; </a>
    </p>
    </div>
    <section class="relative bg-white">
    <img
      class="absolute inset-0 object-[75%] sm:object-[25%] object-cover w-full h-full opacity-25 sm:opacity-100"
      src="https://images.unsplash.com/photo-1609429019995-8c40f49535a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80"
    ...
    <div class="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
      <div class="max-w-xl text-center sm:text-left">
        ...
        <div class="flex flex-wrap gap-4 mt-8 text-center">
          <a class="block w-full px-12 py-3 text-sm font-medium text-white rounded shadow bg-indigo-600 sm:w-auto active:bg-indigo-500 hover:bg-indigo-700 focus:outline-none focus:ring" href="/get-started">
            Get Started
          </a>

          <a class="block w-full px-12 py-3 text-sm font-medium bg-white rounded shadow text-indigo-600 sm:w-auto hover:text-indigo-700 active:text-indigo-500 focus:outline-none focus:ring" href="/about">
            Learn More
          </a>
        </div>
      </div>
    ...
    <div>
      <div class="flex flex-wrap overflow-hidden">
        <div class="w-1/3 overflow-hidden md:w-full lg:w-1/3">
          <!-- Column Content -->
          <a href="" class="relative block p-8 pb-24 border-t-4 border-indigo-600 rounded-sm shadow-xl m-3 my-10">
